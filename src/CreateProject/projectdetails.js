        ...
        <Background>
          ...
          {project ? (
            ...
            <Grid container spacing={2} xs={12} sm={12} md={12} lg={12} xl={12} justifyContent='center' alignItems='center' >
              ...
              <Grid container xs={12} sm={12} md={12} lg={12} xl={12} sx={{ marginLeft: 1, marginTop: 4, marginBottom: 4 }} justifyContent='center' alignItems='center'>

                <Grid item align='center' xs={12} sm={12} md={6} lg={6} xl={6} sx={{ marginTop: 1 }}  >
                  <Button variant="contained" sx={ButtonStyle} onClick={toAddVersion}>Add a Version</Button>

                </Grid>
                <Grid item align='center' xs={12} sm={12} md={6} lg={6} xl={6} sx={{ marginTop: 1 }}>
                  <Button variant="contained" sx={ButtonStyle} onClick={toEditLastVersion}>Edit Last Version</Button>
                </Grid>
              </Grid>
